      ...
      <div class="row text-center">
        <div class="col-lg-3 col-md-6">
          <div class="info">
            ...
            <h5 class="mt-2">Se voluntario</h5>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="info">
            ...
            <h5 class="mt-2">Ingresa tus datos</h5>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="info">
            ...
            <h5 class="mt-2">Convalida tus practicas</h5>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="info">
            <div class="icon icon-shape text-center">
              <svg class="text-primary" width="43px" height="20px" class="text-primarys" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <h5 class="mt-2">Ayuda a los demas</h5>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 ms-auto me-auto text-center">
          <h2 class="text-gradient text-primary">Simple y facil de usar</h2>
          <p>
        ...
        <div class="col-md-6 position-relative">
          ...
          <div class="position-absolute bottom-0 mb-5 ms-n2 me-3 start-0 end-2 d-md-block d-none">
            <div class="blur-shadow-image">
              <img class="image-container rounded-3 img-fluid position-relative bg-cover" src="https://raw.githubusercontent.com/creativetimofficial/public-assets/master/soft-ui-design-system/assets/img/coding.jpg">
            </div>
          </div>
        </div>
        <div class="col-md-5">
          ...
          <p>The Arctic Ocean freezes every winter and much of the sea-ice then thaws every summer, and that process will continue whatever happens with climate change. Even if the Arctic continues to be one of the fastest-warming regions of the world, it will always be plunged into bitterly cold polar dark every winter. And year-by-year, for all kinds of natural reasons, there’s huge variety of the state of the ice. For a start, it does not automatically follow that a record amount of ice will melt this summer
          </p>
          ...
          <div id="carouselExampleIndicator" class="carousel slide py-7" data-bs-ride="carousel">
            <ol class="carousel-indicators justify-content-start ms-0">
              <a class="active" href="javascript:;">
                <img src="../assets/img/team-4.jpg" alt="..." class="avatar avatar-sm avatar-scale-up shadow border-0" data-bs-target="#carouselExampleIndicator" data-bs-slide-to="0">
                <span class="text-white mx-2">&#124;</span>
              </a>
              <a href="javascript:;">
                <img src="../assets/img/team-3.jpg" alt="..." class="avatar avatar-sm avatar-scale-up shadow border-0" data-bs-target="#carouselExampleIndicator" data-bs-slide-to="1">
                <span class="text-white mx-2">&#124;</span>
              </a>
              <a href="javascript:;">
            ...
            <div class="carousel-inner">
              ...
              <hr class="text-white horizontal opacity-6 mb-4 mt-2 w-25 text-left">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-5 ms-auto me-auto text-center">
          ...
          <h3 class="text-gradient text-primary mb-0 mt-4">Conoce tus actividades</h3>
          <h3>Encontraras muchas de ellas</h3>
