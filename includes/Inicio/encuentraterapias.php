<section class="pt-sm-8 pb-10 position-relative bg-gradient-secondary overflow-hidden">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 text-left mb-5 mt-5">
        <h3 class="text-black z-index-1 position-relative">TERAPIAS</h3>
        <p class="text-black opacity-8 mb-0">Encuentra la terapia mas adaptable a tus necesidades.</p>
      </div>
    </div>
    <div class="row">
      ...
      <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g id="Artboard" transform="translate(0.000000, 5.000000)" fill="#FFFFFF" fill-rule="nonzero">
          <g id="wave-up" transform="translate(0.000000, -5.000000)">
            <path d="M0,70 C298.666667,105.333333 618.666667,95 960,39 C1301.33333,-17 1621.33333,-11.3333333 1920,56 L1920,165 L0,165 L0,70 Z" id="Path" fill="#ffffff"></path>
          </g>
        </g>
      </g>
    </svg>
