       ...
       <div id="carouselExampleIndicator" class="carousel slide py-7" data-bs-ride="carousel">
         <ol class="carousel-indicators justify-content-start ms-0">
           <a class="active" href="javascript:;">
             <img src="assets/img/team-2.jpg" alt="..." class="avatar avatar-sm avatar-scale-up shadow border-0" data-bs-target="#carouselExampleIndicator" data-bs-slide-to="0">
         ...
         <div class="carousel-inner">
           <h2 class="text-white mb-0">testimonios</h2>
           <hr class="text-white horizontal opacity-6 mb-4 mt-2 w-25 text-left">
           <div class="carousel-item active">
             <h6 class="text-white opacity-8 pe-5">"I'm not the kind of fool who's gonna sit and sing to you
About stars, girl
But last night I looked up into the dark half of the blue
And they'd gone backwards"</h6>
             <div class="author mt-4">
               <div class="name">
                 <span class="text-white">Alex Turner</span>
                 <div class="stats">
...
For such a sight as the one I caught when I saw your"</h6>
             <div class="author mt-4">
               <div class="name">
                 <span class="text-white">Alex Turner</span>
                 <div class="stats">
           ...
           <div class="carousel-item">
             <h6 class="text-white opacity-8 pe-5">"Fingers dimming the lights
Like you're used to being told that you're trouble
And I spent all night
Stuck on the puzzle"</h6>
             <div class="author mt-4">
               <div class="name">
                 <span class="text-white">Alex Turner</span>
                 <div class="stats">
