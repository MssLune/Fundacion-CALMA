        ...
        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
          <div class="card card-plain">
            <div class="card-header pb-0 text-left">
              <h2 class="text-dark mb-4 texto-registrar">REGISTRAR ADMINISTRADOR</h2>
            ...
            <div class="card-body">
              <form id="form-registro" action="#" target="dummyframe" method="POST" onsubmit="registrar_nuevo_usuario();" >
                ...
                <div class="mb-3">
                  <input type="text" name="area_registrar" id="area-registro" class="form-control form-control-lg" placeholder="Area" aria-label="Area" aria-describedby="area-addon" required>
                </div>
